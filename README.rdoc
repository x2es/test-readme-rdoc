...
This extension aims to extend the spree auth logic by optional disabling of:
...
1. Setup your Spree::Auth::Disabler::Config propertly (see bellow).
...
* to fix English grammar in this text (now I am tring to setup articles, but I am not feel yet this aspect
to do this job propertly)
